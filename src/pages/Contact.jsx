...
const sendEmail = (e) => {
  ...
  // EmailJS send form
  emailjs.sendForm(
    'service_43qwp69',  // Replace with your service ID
    'template_tlyfm4r', // Replace with your template ID
    e.target,           // Form element
    'WJrZc74R4xW3vYIXK' // Replace with your public key
    )
  .then(() => {
            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Coimbatore</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>6383129577</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>balajivasagan@gmail.com</span>
                </div>
              </div>
            </div>
