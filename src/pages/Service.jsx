    ...
    <div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 border border-gray-300">
            ...
            >
              <i className="fa-brands fa-react text-4xl text-blue-600 mb-6 rotate-icon"></i> 
